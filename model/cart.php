...
function viewcart($del)
{
    ...
    $i = 0;
    if ($del == 1) {
        $xoasp_top = '<td style="font-weight: bold;">Thao tac</td>';
    } else {
        $xoasp_top = "";
        $xoasp_duoi = "";
    }
    echo '<tr>
    <td style="font-weight: bold;">Hinh</td>
    <td style="font-weight: bold;">San pham</td>
    <td style="font-weight: bold;">Don gia</td>
    <td style="font-weight: bold;">So luong</td>
    <td style="font-weight: bold;">Thanh tien</td> 
    ' . $xoasp_top . ' 
</tr>';
